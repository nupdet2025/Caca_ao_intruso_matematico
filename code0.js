...
gdjs.IntroCode.GDGarotaObjects1= [];
gdjs.IntroCode.GDGarotaObjects2= [];
...
gdjs.IntroCode.asyncCallback17102628 = function (runtimeScene, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.5), (runtimeScene) => (gdjs.IntroCode.asyncCallback17102628(runtimeScene, asyncObjectsList)));
}
}
...
if (isConditionTrue_0) {
gdjs.copyArray(runtimeScene.getObjects("Garota"), gdjs.IntroCode.GDGarotaObjects1);
{for(var i = 0, len = gdjs.IntroCode.GDGarotaObjects1.length ;i < len;++i) {
    gdjs.IntroCode.GDGarotaObjects1[i].getBehavior("Animation").setAnimationName("iddle");
}
...
gdjs.IntroCode.GDGarotaObjects1.length = 0;
gdjs.IntroCode.GDGarotaObjects2.length = 0;
